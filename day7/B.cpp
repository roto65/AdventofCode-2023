...
std::string adjustHex(std::string s) {
    std::replace(s.begin(), s.end(), '2', '1');
    std::replace(s.begin(), s.end(), '3', '2');
    std::replace(s.begin(), s.end(), '4', '3');
    std::replace(s.begin(), s.end(), '5', '4');
    std::replace(s.begin(), s.end(), '6', '5');
    std::replace(s.begin(), s.end(), '7', '6');
    std::replace(s.begin(), s.end(), '8', '7');
    std::replace(s.begin(), s.end(), '9', '8');
    std::replace(s.begin(), s.end(), 'T', '9');
    std::replace(s.begin(), s.end(), 'J', '0');
